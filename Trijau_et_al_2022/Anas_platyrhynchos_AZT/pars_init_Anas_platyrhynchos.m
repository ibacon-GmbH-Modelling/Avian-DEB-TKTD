...
par.z = 3.998;       free.z     = 0;   units.z = '-';            label.z = 'zoom factor'; 
par.F_m = 6.5;        free.F_m   = 0;   units.F_m = 'l/d.cm^2';   label.F_m = '{F_m}, max spec searching rate'; 
par.kap_X =0.4094;     free.kap_X = 0;   units.kap_X = '-';        label.kap_X = 'digestion efficiency of food to reserve'; 
par.kap_P = 0.1;      free.kap_P = 0;   units.kap_P = '-';        label.kap_P = 'faecation efficiency of food to faeces'; 
par.v = 0.03064;      free.v     = 0;   units.v = 'cm/d';         label.v = 'energy conductance'; 
par.kap = 	0.6837;     free.kap   = 0;   units.kap = '-';          label.kap = 'allocation fraction to soma'; 
par.kap_R = 0.95;     free.kap_R = 0;   units.kap_R = '-';        label.kap_R = 'reproduction efficiency'; 
par.p_M =  	574.6;      free.p_M   = 0;   units.p_M = 'J/d.cm^3';   label.p_M = '[p_M], vol-spec somatic maint'; 
par.p_T = 0;          free.p_T   = 0;   units.p_T = 'J/d.cm^2';   label.p_T = '{p_T}, surf-spec somatic maint'; 
par.k_J = 0.002;      free.k_J   = 0;   units.k_J = '1/d';        label.k_J = 'maturity maint rate coefficient'; 
par.E_G = 7235.99;       free.E_G   = 0;   units.E_G = 'J/cm^3';     label.E_G = '[E_G], spec cost for structure'; 
par.E_Hb = 2.668e+04 	 	;  free.E_Hb  = 0;   units.E_Hb = 'J';         label.E_Hb = 'maturity at birth'; 
par.E_Hp = 5.952e+06	; free.E_Hp  = 0;   units.E_Hp = 'J';         label.E_Hp = 'maturity at puberty'; 
...
par.t_s = 231;        free.t_s  = 0;   units.t_s = 'd';          label.t_s = 'time since birth at reproduction stimulus';  
...
% General
par.k_e = 10;          free.k_e   = 0;   units.k_e = 'd-1';        label.k_e = 'elimination rate constant'; 
...
% Sublethal
par.c_0 = 0.06893;    free.c_0   = 1;   units.c_0 = 'ppm a.i. / 1000';  label.c_0 = 'no-effect concentration sub-lethal';
par.c_T = 0.5408;     free.c_T   = 1 ;  units.c_T = 'ppm a.i. / 1000';  label.c_T = 'tolerance concentration';
